                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('signup.submit') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" pattern="7[0-9]{8}"
                                maxlength="9" placeholder="7XXXXXXXX"
                                title="Please enter a valid Yemeni phone number starting with 7" required>
                        ...
                        <div class="mb-3">
                            ...
                            <small id="passwordError" class="text-danger" style="display:none;">
                                Password must be at least 8 characters long and include an uppercase letter, a lowercase
            ...
            <div class="modal-content">
                <div class="modal-body text-center p-lg-4">
                    ...
                    <button type="button" class="btn btn-sm mt-3 btn-success" data-bs-dismiss="modal"
                        onclick="redirectToLogin()">Ok</button>
                </div>
            </div>
        </div>
    </div>
