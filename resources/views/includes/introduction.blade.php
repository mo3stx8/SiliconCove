            ...
            <div id="carouselExample" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1500">
                ...
                <div class="carousel-inner rounded shadow" style="max-height: 500px; overflow: hidden;">
                    ...
                    <div class="carousel-item">
                        <img src="{{ asset('images/004.jpg') }}"
                            class="d-block w-100" style="height: 450px; object-fit: cover; "
                            alt="Shop Fast. Shop Safe. Shop Smart.">
                        <div class="carousel-caption bg-dark bg-opacity-50 rounded p-2">
                            <h5 class="text-white fw-bold">Shop Fast. Shop Safe. Shop Smart.</h5>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="{{ asset('images/005.jpg') }}"
                            class="d-block w-100" style="height: 450px; object-fit: cover; "
                            alt="From Us to You, Right at Your Door.">
                        <div class="carousel-caption bg-dark bg-opacity-50 rounded p-2">
